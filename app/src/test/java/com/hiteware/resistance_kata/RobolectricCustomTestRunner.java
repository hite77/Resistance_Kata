...
/**
 *  Pulled from Stack OverFlow for error that could not find resources.
 */
public class RobolectricCustomTestRunner extends RobolectricTestRunner {

    private static final String BUILD_OUTPUT = "build/intermediates";

    public RobolectricCustomTestRunner(Class<?> klass) throws InitializationError {
        super(klass);
    }
